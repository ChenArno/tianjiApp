...
//  WeexEros
//
//  Created by chen century on 2018/3/21.
...
@interface Tjchart()<WKNavigationDelegate>
...
- (void)createWebView
{
    WXPerformBlockOnMainThread(^{
        ...
        NSString *filePath = [[NSBundle mainBundle]pathForResource:@"tj-chart" ofType:@"html"];
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation
{
    ...
    NSString *echartJsThemePath = [[NSBundle mainBundle] pathForResource:@"tjCurve" ofType:@"js"];
    NSString *echartJsStr = [NSString stringWithContentsOfFile:echartJsPath encoding:NSUTF8StringEncoding error:nil];
    NSString *echartJsThemeStr = [NSString stringWithContentsOfFile:echartJsThemePath encoding:NSUTF8StringEncoding error:nil];
    [self webViewRunScript:echartJsStr];
    [self webViewRunScript:echartJsThemeStr];
